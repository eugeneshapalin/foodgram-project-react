...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        try:
            Tag.objects.get_or_create(name='Мясо',color='#FF0000',slug='meat')
            Tag.objects.get_or_create(name='Веган',color='#00FF00',slug='vegan')
            Tag.objects.get_or_create(name='Прочее',color='#EEE8AA',slug='pr')
            Tag.objects.get_or_create(name='Звезда мишлен',color='#4682B4',slug='mishk')
        except FileNotFoundError:
        ...
        try:
            User.objects.get_or_create(
                username='test',
                email='test@mail.com',
                password='pbkdf2_sha256$150000$04dIcOWi9tFx$RIuSYggPvu/sxyGR2yBTpxj5FkNhuj7upAlMY/UTiPM=', #Qwerty12345678!
